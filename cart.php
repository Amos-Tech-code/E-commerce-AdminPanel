...
function remove_cart_item(){
  global $con;
  // Check if the form is submitted and 'removeItem' index is set in $_POST
  if(isset($_POST['remove_cart']) && isset($_POST['removeItem'])){
    // Loop through each selected item to remove from the cart
    foreach($_POST['removeItem'] as $remove_id){
      ...
      if($run_delete){
        // Redirect to cart.php after successful deletion
